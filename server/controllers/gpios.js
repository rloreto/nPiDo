...
module.exports = {
    ...
    getDhtSensor: function(req, res){
      ...
      var sensor = {
          ...
          read: function () {
              ...
              console.log('end getDhtSensor');
              return res.json({ temperature: readout.temperature, humidity: readout.humidity});
          }
      };
    ...
    getAnalogValue: function(req, res){
      ...
      try{
        ...
        arduino.on('connect', function(){
          ...
          return res.json({ luminance: luminance });
        });
      } catch(e){
        return res.json({ luminance: luminance });
      }
    ...
    getAvailablesGpios: function(req, res){
      ...
      .then(function(result){
        res.json(result.map(function(gpio){
          return {number:gpio.number, ip:gpio.ip};
        }));
      });
    ...
    updateVirtualGpio: function(req, res){
      ...
      Gpio.update({ ip:ip, number: number}, {direction: direction, value: value})
